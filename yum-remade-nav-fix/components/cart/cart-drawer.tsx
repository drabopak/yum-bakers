...
import { playInc, playDec, playRemove, playSuccess } from '@/lib/sounds'
...
export function CartDrawer() {
  ...
  return (
    <>
      ...
      {ordered && (
        <div className="toast-in fixed bottom-6 left-1/2 z-[60] max-w-[90vw] rounded-full bg-mahogany px-6 py-3.5 text-center text-sm font-medium text-cream shadow-2xl">
          Order placed! Your nearest YUM branch will confirm your order shortly.
        </div>
      )}
    </>
  )
